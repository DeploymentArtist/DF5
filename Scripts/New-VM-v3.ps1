...
Function CreateUnattendFile($VMName,$JoinWorkgroup,$ProductKey,$OrgName,$Fullname,$TimeZoneName,$InputLocale,$SystemLocale,$UILanguage,$UserLocale,$OSDAdapter0DNS1,$OSDAdapter0DNS2,$DNSDomain,$OSDAdapter0IPAddressList,$OSDAdapter0Gateways,$OSDAdapter0SubnetMaskPrefix,$AdminPassword){
Logit "Start"
...
$AdminPassword = $Settings.ViaMonstra.MachineDefaults.AdminPassword
$OrgName = $Settings.ViaMonstra.MachineDefaults.OrgName
$Fullname = $Settings.ViaMonstra.MachineDefaults.FullName
$TimeZoneName = $Settings.ViaMonstra.MachineDefaults.TimeZoneName
$InputLocale = $Settings.ViaMonstra.MachineDefaults.InputLocale
$SystemLocale = $Settings.ViaMonstra.MachineDefaults.SystemLocale
$UILanguage = $Settings.ViaMonstra.MachineDefaults.UILanguage
$UserLocale = $Settings.ViaMonstra.MachineDefaults.UserLocale
$OSDAdapter0Gateways = $Settings.ViaMonstra.MachineDefaults.OSDAdapter0Gateways
$OSDAdapter0DNS1 = $Settings.ViaMonstra.MachineDefaults.OSDAdapter0DNSServerList[0]
$OSDAdapter0DNS2 = $Settings.ViaMonstra.MachineDefaults.OSDAdapter0DNSServerList[1]
$OSDAdapter0SubnetMaskPrefix = $Settings.ViaMonstra.MachineDefaults.OSDAdapter0SubnetMaskPrefix
$ProductKey = $Settings.ViaMonstra.MachineDefaults.ProductKey
$VMSwitchName = $Settings.ViaMonstra.MachineDefaults.VMSwitchName

#Setting DomainDefaults
$DNSDomain = $Settings.ViaMonstra.DomainDefaults.DNSDomain
$DomainNetBios = $Settings.ViaMonstra.DomainDefaults.DomainNetBios
$DomainAdmin = $Settings.ViaMonstra.DomainDefaults.DomainAdmin
$DomainAdminPassword = $Settings.ViaMonstra.DomainDefaults.DomainAdminPassword
$DomainAdminDomain = $Settings.ViaMonstra.DomainDefaults.DomainAdminDomain
$MachienObjectOU = $Settings.ViaMonstra.DomainDefaults.MachienObjectOU

#Settings WorkgroupDefaults
$JoinWorkgroup = $Settings.ViaMonstra.WorkgroupDefaults.WorkgroupName
...
Write-Host "CreateUnattendFile $VMName $JoinWorkgroup $ProductKey $OrgName $Fullname $TimeZoneName $InputLocale $SystemLocale $UILanguage $UserLocale $OSDAdapter0DNS1 $OSDAdapter0DNS2 $DNSDomain $OSDAdapter0IPAddressList $OSDAdapter0Gateways $OSDAdapter0SubnetMaskPrefix $AdminPassword"
CreateUnattendFile $VMName $JoinWorkgroup $ProductKey $OrgName $Fullname $TimeZoneName $InputLocale $SystemLocale $UILanguage $UserLocale $OSDAdapter0DNS1 $OSDAdapter0DNS2 $DNSDomain $OSDAdapter0IPAddressList $OSDAdapter0Gateways $OSDAdapter0SubnetMaskPrefix $AdminPassword
}}
